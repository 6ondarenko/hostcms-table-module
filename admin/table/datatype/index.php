...
// Код формы
$sAdminFormAction = '/admin/table/datatype/index.php';
...
$oAdmin_Form_Controller
	...
	->title(Core::_('Table_Datatype.title'))
	->pageTitle(Core::_('Table_Datatype.title'));
...
$oAdmin_Form_Entity_Menus->add(
	Admin_Form_Entity::factory('Menu')
		...
		->add(
			Admin_Form_Entity::factory('Menu')
				->name(Core::_('Table_Datatype.add'))
				->icon('fa fa-plus')
...
$oAdmin_Form_Entity_Breadcrumbs->add(
	...
	Admin_Form_Entity::factory('Breadcrumb')
		->name(Core::_('Table_Datatype.title'))
		->href(
...
{
	$oTable_Datatype_Controller_Edit = new Table_Datatype_Controller_Edit(
		$oAdmin_Form_Action
	);

	$oTable_Datatype_Controller_Edit
		->addSkipColumn('id')
		->addSkipColumn('site_id')
		->addEntity($oAdmin_Form_Entity_Breadcrumbs);

	// Добавляем типовой контроллер редактирования контроллеру формы
	$oAdmin_Form_Controller->addAction($oTable_Datatype_Controller_Edit);
}
...
$oAdmin_Form_Dataset = new Admin_Form_Dataset_Entity(
	Core_Entity::factory('Table_Datatype')
);
